...
public class Main {
    ...
    public static void main(String[] args) {
      ...
      fleet.addCar(new ElectricCar("CF 93456", "Tesla","Y",5,67, 533));
      fleet.addCar(new ElectricCar("CF 93456", "Volvo","C40 Recharge",5,78, 579));
      fleet.addCar(new ElectricCar("CF 93456", "Mercedes","EQA 250+",5,74, 552));

      fleet.printFleet();
      fleet.printTotalRegistrationFee();
    }
}